...
# direct methods
.method constructor <init>(Ljava/lang/String;Lkotlin/jvm/functions/Function1;Landroidx/compose/ui/Modifier;ZZLandroidx/compose/ui/text/TextStyle;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function2;ZLandroidx/compose/ui/text/input/VisualTransformation;Landroidx/compose/foundation/text/KeyboardOptions;Landroidx/compose/foundation/text/KeyboardActions;ZIILandroidx/compose/foundation/interaction/MutableInteractionSource;Landroidx/compose/ui/graphics/Shape;Landroidx/compose/material3/TextFieldColors;IIII)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$textStyle:Landroidx/compose/ui/text/TextStyle;
    ...
    iput v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$changed:I

    move/from16 v1, p25

    iput v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$changed1:I

    move/from16 v1, p26

    iput v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$changed2:I

    move/from16 v1, p27

    iput v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$default:I
...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    iget-object v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$value:Ljava/lang/String;

    iget-object v2, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$onValueChange:Lkotlin/jvm/functions/Function1;

    iget-object v3, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$modifier:Landroidx/compose/ui/Modifier;
    ...
    iget-object v6, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$textStyle:Landroidx/compose/ui/text/TextStyle;

    iget-object v7, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$label:Lkotlin/jvm/functions/Function2;

    iget-object v8, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$placeholder:Lkotlin/jvm/functions/Function2;

    iget-object v9, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$leadingIcon:Lkotlin/jvm/functions/Function2;

    iget-object v10, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$trailingIcon:Lkotlin/jvm/functions/Function2;

    iget-object v11, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$prefix:Lkotlin/jvm/functions/Function2;

    iget-object v12, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$suffix:Lkotlin/jvm/functions/Function2;

    iget-object v13, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$supportingText:Lkotlin/jvm/functions/Function2;

    iget-boolean v14, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$isError:Z

    iget-object v15, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$visualTransformation:Landroidx/compose/ui/text/input/VisualTransformation;

    move-object/from16 p1, v1

    iget-object v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$keyboardOptions:Landroidx/compose/foundation/text/KeyboardOptions;

    move-object/from16 v16, v1

    iget-object v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$keyboardActions:Landroidx/compose/foundation/text/KeyboardActions;

    move-object/from16 v17, v1

    iget-boolean v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$singleLine:Z

    move/from16 v18, v1

    iget v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$maxLines:I

    move/from16 v19, v1

    iget v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$minLines:I
    ...
    iget v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$changed:I
    ...
    iget v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$changed1:I

    invoke-static {v1}, Landroidx/compose/runtime/RecomposeScopeImplKt;->updateChangedFlags(I)I

    move-result v26

    iget v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$changed2:I

    invoke-static {v1}, Landroidx/compose/runtime/RecomposeScopeImplKt;->updateChangedFlags(I)I

    move-result v27

    iget v1, v0, Landroidx/compose/material3/TextFieldKt$TextField$3;->$$default:I
