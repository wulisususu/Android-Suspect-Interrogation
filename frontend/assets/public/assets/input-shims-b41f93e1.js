...
import { d as doc, K as Keyboard, h as addEventListener, j as removeEventListener, e as componentOnReady, f as findClosestIonContent, k as KeyboardResize, l as win, m as raf, n as getScrollElement, o as scrollByPoint } from "../index.js";
/*!
...
const jsSetFocus = (componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, disableClonedInput = false, platformHeight = 0, waitForResize = true) => __async(void 0, null, function* () {
...
const startInputShims = (config, platform) => __async(void 0, null, function* () {
  if (doc === void 0) {
    return;
  }
