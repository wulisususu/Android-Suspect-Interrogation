...
path = ROOT / "webapp/src/views/SystemSettingsView.vue"
source = path.read_text(encoding="utf-8")
if "const activeTab = ref<'library' | 'calibration'>('library')" not in source:
    raise SystemExit("Task10 settings apply anchor missing")
path.write_text(r'''<script setup lang="ts">
...
''', encoding="utf-8")
print("Task10 settings UI apply complete")
