...
path = ROOT / "webapp/src/api/speakerCalibration.ts"
source = path.read_text(encoding="utf-8")
if "export type SpeakerCalibrationStatus =" not in source or "fetchSpeakerCalibrationStatus()" not in source:
    raise SystemExit("Task10 API apply anchor missing")
path.write_text(r'''import { http } from './http'
