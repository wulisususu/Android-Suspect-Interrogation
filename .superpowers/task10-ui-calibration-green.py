...
path = ROOT / "webapp/src/components/SpeakerCalibrationCenter.vue"
source = path.read_text(encoding="utf-8")
if "利用全局民警声纹库，为当前 XVector 与生产麦克风计算设备级判定参数。" not in source:
    raise SystemExit("Task10 calibration apply anchor missing")
path.write_text(r'''<script lang="ts">
...
''', encoding="utf-8")
print("Task10 calibration UI apply complete")
